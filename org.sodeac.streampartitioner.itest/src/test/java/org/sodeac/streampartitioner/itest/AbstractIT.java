...
public abstract class AbstractIT
{
    ...
    {
        // System.out.println("reactorBundle: artifactId=" + artifactId + ", version=" + version);
        ...
        if(new File(fileName).exists()) { return bundle("file:" + new File(fileName).getCanonicalPath()); }
